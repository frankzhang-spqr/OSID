...
def create_model(vocab_size):
    """Create Model A for offensive language detection"""
...
def train_model():
    ...
    print("Training Model A (Offensive vs Non-Offensive)...")
    history = model.fit(
        X_train, y_train,
